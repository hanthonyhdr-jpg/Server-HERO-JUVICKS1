...
def apply_modern_style(logo_url=""):
    ...
    Tema gerado pelo Editor Visual em 08/03/2026 14:26
    """
    st.markdown(f"""
        <style>
        ...
        div[data-testid="stMetric"] {{
            background: linear-gradient(145deg, rgba(30, 41, 59, 0.6), rgba(0, 0, 0, 0.6));
...
def apply_signature_management_style():
    ...
    st.markdown("""
        ...
        .stat-card:hover { transform: translateY(-3px); border-color: #f1f5f9; }
        .stat-num { font-size: 2.1rem; font-weight: 800; color: #f1f5f9; }
        ...
        .doc-card:hover { border-color: #f1f5f9; }
    ...
    """.replace('{accent}', '#f1f5f9').format(accent='#f1f5f9'), unsafe_allow_html=True)
...
def get_signature_client_style():
    ...
    return """
        ...
        .client-header {
            ...
            padding: 32px; border-radius: 20px; text-align: center; margin-bottom: 24px;
...
def get_login_style():
    ...
    return """
        ...
        .stApp { background: radial-gradient(circle at 20% 20%, #1e293b 0%, #020617 100%) !important; font-family: 'Space Grotesk', sans-serif !important; }
        ...
        .stTextInput input { background-color: rgba(15, 23, 42, 0.6) !important; border: 1px solid rgba(255, 255, 255, 0.1) !important; border-radius: 12px !important; color: #f8fafc !important; padding: 12px 16px !important; transition: all 0.3s ease !important; }
...
def apply_license_style():
    ...
    st.markdown("""
        ...
        [data-testid="stSidebar"], [data-testid="stHeader"], [data-testid="stToolbar"] { display: none !important; }
        #MainMenu, footer, header { visibility: hidden; }
        .stApp { background-color: #020617 !important; font-family: 'Space Grotesk', sans-serif !important; }

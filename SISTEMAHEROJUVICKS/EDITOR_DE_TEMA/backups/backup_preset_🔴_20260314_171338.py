...
_CSS_STATIC = """
    ...
    .stApp {
        ...
        color: #1fff00;                /* Cor do texto global */
    }
    ...
    [data-testid="stSidebar"] .stMarkdown p {
        color: #22ff10 !important;    /* ← TEXTO SIDEBAR */
    }

    /* 3C. Item ativo / selecionado na Sidebar */
    [data-testid="stSidebar"] [aria-selected="true"],
    [data-testid="stSidebar"] [aria-current="page"] {
        background: rgba(31, 255, 0, 0.12) !important;  /* ← FUNDO ITEM ATIVO SIDEBAR */
        border-left: 3px solid #1fff00 !important;       /* ← BORDA ITEM ATIVO SIDEBAR */
    ...
    [data-testid="stSidebar"] h3 {
        color: #1fff00 !important;    /* ← TÍTULOS SIDEBAR */
    }
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(10,26,10,0.80), rgba(0,0,0,0.80)); /* ← FUNDO CARD */
    ...
    div[data-testid="stMetric"]:hover {
        ...
        border-color: #1fff00;        /* ← COR HOVER BORDA CARD MÉTRICA */
        box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3);
    }

    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"] {
        background: rgba(10,26,10,0.80);  /* ← FUNDO CONTAINER */
    ...
    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"]:hover {
        border-color: rgba(31, 255, 0, 0.4);  /* ← HOVER BORDA CONTAINER */
    }
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #1fff00, #16d900) !important;  /* ← COR BOTÃO */
        color: white !important;      /* ← TEXTO BOTÃO */
    }
    .stButton > button:hover {
        transform: scale(1.02) !important;
        box-shadow: 0 0 15px rgba(31, 255, 0, 0.4) !important;  /* ← GLOW HOVER BOTÃO */
    }
    .stButton > button[kind="secondary"] {
        background: rgba(255,255,255,0.06) !important;   /* ← BOTÃO SECUNDÁRIO */
        color: #22ff10 !important;
    }
    ...
    .stTextarea textarea {
        ...
        border: 1px solid rgba(255,255,255,0.1) !important;
        color: #1fff00 !important;   /* ← TEXTO INPUT */
    }
    .stTextInput > div > div > input:focus,
    .stTextarea textarea:focus {
        border-color: #1fff00 !important;  /* ← BORDA FOCUS INPUT */
        box-shadow: 0 0 0 2px rgba(31,255,0,0.15) !important;
    }
    ...
    ::-webkit-scrollbar-thumb { background: #0a1a0a; border-radius: 100px; }  /* ← THUMB SCROLLBAR */
    ::-webkit-scrollbar-thumb:hover { background: #1fff00; }   /* ← HOVER SCROLLBAR */
    ...
    div[data-baseweb="tab-highlight"] {
        background-color: #1fff00 !important;  /* ← SUBLINHADO TAB ATIVA */
    }

    /* ═══════════════════════════════════════
       10. TIPOGRAFIA GERAL (Conteúdo principal)
       ═══════════════════════════════════════ */
    p, .stMarkdown p { color: #22ff10; }          /* ← TEXTO SECUNDÁRIO */
    label { color: #22ff10 !important; }           /* ← LABELS */
    h1, h2, h3 { color: #1fff00 !important; }     /* ← TÍTULOS */
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 14/03/2026 17:12

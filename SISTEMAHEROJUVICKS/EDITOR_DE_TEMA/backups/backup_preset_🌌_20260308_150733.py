...
_CSS_STATIC = """
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(30,41,59,0.80), rgba(0,0,0,0.80)); /* ← FUNDO CARD */
    ...
    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"] {
        background: rgba(30,41,59,0.80);  /* ← FUNDO CONTAINER */
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #f1f5f9, #94a3b8) !important;  /* ← COR BOTÃO */
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 08/03/2026 14:58

...
_CSS_STATIC = """
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(30,41,59,0.60), rgba(0,0,0,0.60));
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #f1f5f9, #0aff00) !important;
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 08/03/2026 14:39

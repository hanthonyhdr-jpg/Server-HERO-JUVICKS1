...
_CSS_STATIC = """
    ...
    [data-testid="stSidebar"] [aria-current="page"] {
        background: rgba(241, 245, 249, 0.12) !important;  /* ← FUNDO ITEM ATIVO SIDEBAR */
        border-left: 3px solid #f1f5f9 !important;       /* ← BORDA ITEM ATIVO SIDEBAR */
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(30,41,59,0.75), rgba(0,0,0,0.75)); /* ← FUNDO CARD */
    ...
    div[data-testid="stMetric"]:hover {
        ...
        border-color: #f1f5f9;        /* ← COR HOVER BORDA CARD MÉTRICA */
        box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3);
    }

    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"] {
        background: rgba(30,41,59,0.75);  /* ← FUNDO CONTAINER */
    ...
    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"]:hover {
        border-color: rgba(241, 245, 249, 0.4);  /* ← HOVER BORDA CONTAINER */
    }
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #f1f5f9, #c0c8d8) !important;  /* ← COR BOTÃO */
        color: white !important;      /* ← TEXTO BOTÃO */
    }
    .stButton > button:hover {
        transform: scale(1.02) !important;
        box-shadow: 0 0 15px rgba(241, 245, 249, 0.4) !important;  /* ← GLOW HOVER BOTÃO */
    }
    ...
    .stTextarea textarea:focus {
        border-color: #f1f5f9 !important;  /* ← BORDA FOCUS INPUT */
        box-shadow: 0 0 0 2px rgba(241,245,249,0.15) !important;
    }
    ...
    ::-webkit-scrollbar-thumb:hover { background: #f1f5f9; }   /* ← HOVER SCROLLBAR */
    ...
    div[data-baseweb="tab-highlight"] {
        background-color: #f1f5f9 !important;  /* ← SUBLINHADO TAB ATIVA */
    }
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 08/03/2026 14:54

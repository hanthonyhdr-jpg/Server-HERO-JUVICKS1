...
def apply_modern_style(logo_url=""):
    ...
    st.markdown(f"""
        ...
        .stButton > button {{
            ...
            background: linear-gradient(to bottom right, #1fff00, #0284c7) !important;
...
def get_signature_client_style():
    ...
    return """
        ...
        .stButton > button {
            border-radius: 13px !important;
            background: linear-gradient(135deg, #1fff00, #0284c7) !important;
            color: white !important;
            font-weight: 600 !important;
...
def get_login_style():
    ...
    return """
        ...
        .stButton > button {
            background: linear-gradient(135deg, #1fff00 0%, #0284c7 100%) !important;
            color: white !important;
...
def apply_license_style():
    ...
    st.markdown("""
        ...
        .stButton > button {
            background: linear-gradient(135deg, #1fff00 0%, #6366f1 100%) !important;
            color: white !important;
            border: none !important;
            border-radius: 13px !important;

...
_CSS_STATIC = """
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(30,41,59,0.70), rgba(0,0,0,0.70));
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #f1f5f9, #0081ff) !important;
        color: white !important;
    }
    .stButton > button:hover {
        transform: scale(1.02) !important;
        box-shadow: 0 0 15px rgba(241,245,249,0.4) !important;
    }
    ...
    ::-webkit-scrollbar-thumb { background: #1e293b; border-radius: 100px; }
    ...
    div[data-baseweb="tab-highlight"] { background-color: #f1f5f9 !important; }

    p, .stMarkdown p { color: #00ff1c; }
    label { color: #00ff1c !important; }
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 08/03/2026 14:32
...
def apply_signature_management_style():
    ...
    st.markdown("""
        ...
        .stat-card {
            ...
            padding: 20px 16px; text-align: center; transition: all .25s ease; backdrop-filter: blur(10px);
        }
        ...
        .doc-card {
            ...
            border-radius: 12px; padding: 16px 18px; margin-bottom: 12px; transition: border-color .2s;
        }

...
_CSS_STATIC = """
    ...
    /* ═══════════════════════════════════════
       ...
       ═══════════════════════════════════════ */
    .stApp {
        background: radial-gradient(circle at 50% 50%, #111111 0%, #0a0a0a 100%);
        color: #f5f5f5;                /* Cor do texto global */
    }
    ...
    [data-testid="stSidebar"] {
        background-color: rgba(17, 17, 17, 0.95) !important;   /* ← FUNDO SIDEBAR */
    ...
    [data-testid="stSidebar"] .stMarkdown p {
        color: #a3a3a3 !important;    /* ← TEXTO SIDEBAR */
    }

    /* 3C. Item ativo / selecionado na Sidebar */
    [data-testid="stSidebar"] [aria-selected="true"],
    [data-testid="stSidebar"] [aria-current="page"] {
        background: rgba(163, 163, 163, 0.12) !important;  /* ← FUNDO ITEM ATIVO SIDEBAR */
        border-left: 3px solid #a3a3a3 !important;       /* ← BORDA ITEM ATIVO SIDEBAR */
    ...
    [data-testid="stSidebar"] h3 {
        color: #f5f5f5 !important;    /* ← TÍTULOS SIDEBAR */
    }
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(34,34,34,0.65), rgba(17,17,17,0.65)); /* ← FUNDO CARD */
    ...
    div[data-testid="stMetric"]:hover {
        ...
        border-color: #a3a3a3;        /* ← COR HOVER BORDA CARD MÉTRICA */
        box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3);
    }

    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"] {
        background: rgba(34,34,34,0.65);  /* ← FUNDO CONTAINER */
    ...
    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"]:hover {
        border-color: rgba(163, 163, 163, 0.4);  /* ← HOVER BORDA CONTAINER */
    }
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #a3a3a3, #737373) !important;  /* ← COR BOTÃO */
        color: white !important;      /* ← TEXTO BOTÃO */
    }
    .stButton > button:hover {
        transform: scale(1.02) !important;
        box-shadow: 0 0 15px rgba(163, 163, 163, 0.4) !important;  /* ← GLOW HOVER BOTÃO */
    }
    ...
    .stTextarea textarea {
        ...
        background-color: rgba(17,17,17,0.6) !important;    /* ← FUNDO INPUT */
        border: 1px solid rgba(255,255,255,0.1) !important;
        color: #f5f5f5 !important;   /* ← TEXTO INPUT */
    }
    .stTextInput > div > div > input:focus,
    .stTextarea textarea:focus {
        border-color: #a3a3a3 !important;  /* ← BORDA FOCUS INPUT */
        box-shadow: 0 0 0 2px rgba(163,163,163,0.15) !important;
    }
    ...
    ::-webkit-scrollbar-track { background: #0a0a0a; }          /* ← TRACK SCROLLBAR */
    ::-webkit-scrollbar-thumb { background: #222222; border-radius: 100px; }  /* ← THUMB SCROLLBAR */
    ::-webkit-scrollbar-thumb:hover { background: #a3a3a3; }   /* ← HOVER SCROLLBAR */
    ...
    div[data-baseweb="tab-highlight"] {
        background-color: #a3a3a3 !important;  /* ← SUBLINHADO TAB ATIVA */
    }

    /* ═══════════════════════════════════════
       10. TIPOGRAFIA GERAL (Conteúdo principal)
       ═══════════════════════════════════════ */
    p, .stMarkdown p { color: #a3a3a3; }          /* ← TEXTO SECUNDÁRIO */
    label { color: #a3a3a3 !important; }           /* ← LABELS */
    h1, h2, h3 { color: #f5f5f5 !important; }     /* ← TÍTULOS */
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 08/03/2026 15:08

...
_CSS_STATIC = """
    ...
    .stApp {
        ...
        color: #0f172a;                /* Cor do texto global */
    }
    ...
    [data-testid="stSidebar"] {
        background-color: rgba(241, 245, 249, 0.95) !important;   /* ← FUNDO SIDEBAR */
    ...
    [data-testid="stSidebar"] .stMarkdown p {
        color: #475569 !important;    /* ← TEXTO SIDEBAR */
    }

    /* 3C. Item ativo / selecionado na Sidebar */
    [data-testid="stSidebar"] [aria-selected="true"],
    [data-testid="stSidebar"] [aria-current="page"] {
        background: rgba(2, 132, 199, 0.12) !important;  /* ← FUNDO ITEM ATIVO SIDEBAR */
        border-left: 3px solid #0284c7 !important;       /* ← BORDA ITEM ATIVO SIDEBAR */
    ...
    [data-testid="stSidebar"] h3 {
        color: #0f172a !important;    /* ← TÍTULOS SIDEBAR */
    }
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(255,255,255,0.95), rgba(248,250,252,0.95)); /* ← FUNDO CARD */
    ...
    div[data-testid="stMetric"]:hover {
        ...
        border-color: #0284c7;        /* ← COR HOVER BORDA CARD MÉTRICA */
        box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3);
    }

    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"] {
        background: rgba(255,255,255,0.95);  /* ← FUNDO CONTAINER */
        backdrop-filter: blur(0px);
    ...
    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"]:hover {
        border-color: rgba(2, 132, 199, 0.4);  /* ← HOVER BORDA CONTAINER */
    }
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #0284c7, #0369a1) !important;  /* ← COR BOTÃO */
        color: white !important;      /* ← TEXTO BOTÃO */
    }
    .stButton > button:hover {
        transform: scale(1.02) !important;
        box-shadow: 0 0 15px rgba(2, 132, 199, 0.4) !important;  /* ← GLOW HOVER BOTÃO */
    }
    ...
    .stTextarea textarea {
        ...
        background-color: rgba(248,250,252,0.6) !important;    /* ← FUNDO INPUT */
        border: 1px solid rgba(255,255,255,0.1) !important;
        color: #0f172a !important;   /* ← TEXTO INPUT */
    }
    .stTextInput > div > div > input:focus,
    .stTextarea textarea:focus {
        border-color: #0284c7 !important;  /* ← BORDA FOCUS INPUT */
    ...
    ::-webkit-scrollbar-track { background: #e2e8f0; }          /* ← TRACK SCROLLBAR */
    ::-webkit-scrollbar-thumb { background: #ffffff; border-radius: 100px; }  /* ← THUMB SCROLLBAR */
    ::-webkit-scrollbar-thumb:hover { background: #0284c7; }   /* ← HOVER SCROLLBAR */
    ...
    div[data-baseweb="tab-highlight"] {
        background-color: #0284c7 !important;  /* ← SUBLINHADO TAB ATIVA */
    }

    /* ═══════════════════════════════════════
       10. TIPOGRAFIA GERAL (Conteúdo principal)
       ═══════════════════════════════════════ */
    p, .stMarkdown p { color: #475569; }          /* ← TEXTO SECUNDÁRIO */
    label { color: #475569 !important; }           /* ← LABELS */
    h1, h2, h3 { color: #0f172a !important; }     /* ← TÍTULOS */
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 14/03/2026 17:15

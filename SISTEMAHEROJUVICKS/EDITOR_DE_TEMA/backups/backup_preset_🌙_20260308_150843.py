...
_CSS_STATIC = """
    ...
    /* ═══════════════════════════════════════
       ...
       ═══════════════════════════════════════ */
    .stApp {
        background: radial-gradient(circle at 50% 50%, #1c0a00 0%, #0f0500 100%);
        color: #fff7ed;                /* Cor do texto global */
    }
    ...
    [data-testid="stSidebar"] {
        background-color: rgba(28, 10, 0, 0.95) !important;   /* ← FUNDO SIDEBAR */
    ...
    [data-testid="stSidebar"] .stMarkdown p {
        color: #fdba74 !important;    /* ← TEXTO SIDEBAR */
    }

    /* 3C. Item ativo / selecionado na Sidebar */
    [data-testid="stSidebar"] [aria-selected="true"],
    [data-testid="stSidebar"] [aria-current="page"] {
        background: rgba(249, 115, 22, 0.12) !important;  /* ← FUNDO ITEM ATIVO SIDEBAR */
        border-left: 3px solid #f97316 !important;       /* ← BORDA ITEM ATIVO SIDEBAR */
    ...
    [data-testid="stSidebar"] h3 {
        color: #fff7ed !important;    /* ← TÍTULOS SIDEBAR */
    }
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(45,18,0,0.70), rgba(28,10,0,0.70)); /* ← FUNDO CARD */
    ...
    div[data-testid="stMetric"]:hover {
        ...
        border-color: #f97316;        /* ← COR HOVER BORDA CARD MÉTRICA */
        box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3);
    }

    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"] {
        background: rgba(45,18,0,0.70);  /* ← FUNDO CONTAINER */
    ...
    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"]:hover {
        border-color: rgba(249, 115, 22, 0.4);  /* ← HOVER BORDA CONTAINER */
    }
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #f97316, #ea580c) !important;  /* ← COR BOTÃO */
        color: white !important;      /* ← TEXTO BOTÃO */
    }
    .stButton > button:hover {
        transform: scale(1.02) !important;
        box-shadow: 0 0 15px rgba(249, 115, 22, 0.4) !important;  /* ← GLOW HOVER BOTÃO */
    }
    ...
    .stTextarea textarea {
        ...
        background-color: rgba(28,10,0,0.6) !important;    /* ← FUNDO INPUT */
        border: 1px solid rgba(255,255,255,0.1) !important;
        color: #fff7ed !important;   /* ← TEXTO INPUT */
    }
    .stTextInput > div > div > input:focus,
    .stTextarea textarea:focus {
        border-color: #f97316 !important;  /* ← BORDA FOCUS INPUT */
    ...
    ::-webkit-scrollbar-track { background: #0f0500; }          /* ← TRACK SCROLLBAR */
    ::-webkit-scrollbar-thumb { background: #2d1200; border-radius: 100px; }  /* ← THUMB SCROLLBAR */
    ::-webkit-scrollbar-thumb:hover { background: #f97316; }   /* ← HOVER SCROLLBAR */
    ...
    div[data-baseweb="tab-highlight"] {
        background-color: #f97316 !important;  /* ← SUBLINHADO TAB ATIVA */
    }

    /* ═══════════════════════════════════════
       10. TIPOGRAFIA GERAL (Conteúdo principal)
       ═══════════════════════════════════════ */
    p, .stMarkdown p { color: #fdba74; }          /* ← TEXTO SECUNDÁRIO */
    label { color: #fdba74 !important; }           /* ← LABELS */
    h1, h2, h3 { color: #fff7ed !important; }     /* ← TÍTULOS */

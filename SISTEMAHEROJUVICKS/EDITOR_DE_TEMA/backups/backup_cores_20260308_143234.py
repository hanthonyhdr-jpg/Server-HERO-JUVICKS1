...
_CSS_STATIC = """
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #0081ff, #f1f5f9) !important;
        color: white !important;
    }
    .stButton > button:hover {
        transform: scale(1.02) !important;
        box-shadow: 0 0 15px rgba(0,129,255,0.4) !important;
    }
    ...
    div[data-baseweb="tab-highlight"] { background-color: #0081ff !important; }
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 08/03/2026 14:31

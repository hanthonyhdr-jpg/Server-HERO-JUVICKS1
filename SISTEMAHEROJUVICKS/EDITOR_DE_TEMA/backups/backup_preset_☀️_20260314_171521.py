...
_CSS_STATIC = """
    ...
    /* ═══════════════════════════════════════
       ...
       ═══════════════════════════════════════ */
    .stApp {
        background: radial-gradient(circle at 50% 50%, #0d001a 0%, #070010 100%);
        color: #fdf4ff;                /* Cor do texto global */
    }
    ...
    [data-testid="stSidebar"] {
        background-color: rgba(13, 0, 26, 0.95) !important;   /* ← FUNDO SIDEBAR */
    ...
    [data-testid="stSidebar"] .stMarkdown p {
        color: #e879f9 !important;    /* ← TEXTO SIDEBAR */
    }

    /* 3C. Item ativo / selecionado na Sidebar */
    [data-testid="stSidebar"] [aria-selected="true"],
    [data-testid="stSidebar"] [aria-current="page"] {
        background: rgba(192, 38, 211, 0.12) !important;  /* ← FUNDO ITEM ATIVO SIDEBAR */
        border-left: 3px solid #c026d3 !important;       /* ← BORDA ITEM ATIVO SIDEBAR */
    ...
    [data-testid="stSidebar"] h3 {
        color: #fdf4ff !important;    /* ← TÍTULOS SIDEBAR */
    }
    ...
    div[data-testid="stMetric"] {
        background: linear-gradient(145deg, rgba(26,0,51,0.75), rgba(13,0,26,0.75)); /* ← FUNDO CARD */
    ...
    div[data-testid="stMetric"]:hover {
        ...
        border-color: #c026d3;        /* ← COR HOVER BORDA CARD MÉTRICA */
        box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3);
    }

    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"] {
        background: rgba(26,0,51,0.75);  /* ← FUNDO CONTAINER */
    ...
    [data-testid="stVerticalBlock"] > div > div > div[data-testid="stContainer"]:hover {
        border-color: rgba(192, 38, 211, 0.4);  /* ← HOVER BORDA CONTAINER */
    }
    ...
    .stButton > button {
        ...
        background: linear-gradient(to bottom right, #c026d3, #9333ea) !important;  /* ← COR BOTÃO */
        color: white !important;      /* ← TEXTO BOTÃO */
    }
    .stButton > button:hover {
        transform: scale(1.02) !important;
        box-shadow: 0 0 15px rgba(192, 38, 211, 0.4) !important;  /* ← GLOW HOVER BOTÃO */
    }
    ...
    .stTextarea textarea {
        border-radius: 4px !important;
        background-color: rgba(13,0,26,0.6) !important;    /* ← FUNDO INPUT */
        border: 1px solid rgba(255,255,255,0.1) !important;
        color: #fdf4ff !important;   /* ← TEXTO INPUT */
    }
    .stTextInput > div > div > input:focus,
    .stTextarea textarea:focus {
        border-color: #c026d3 !important;  /* ← BORDA FOCUS INPUT */
    ...
    ::-webkit-scrollbar-track { background: #070010; }          /* ← TRACK SCROLLBAR */
    ::-webkit-scrollbar-thumb { background: #1a0033; border-radius: 100px; }  /* ← THUMB SCROLLBAR */
    ::-webkit-scrollbar-thumb:hover { background: #c026d3; }   /* ← HOVER SCROLLBAR */
    ...
    div[data-baseweb="tab-highlight"] {
        background-color: #c026d3 !important;  /* ← SUBLINHADO TAB ATIVA */
    }

    /* ═══════════════════════════════════════
       10. TIPOGRAFIA GERAL (Conteúdo principal)
       ═══════════════════════════════════════ */
    p, .stMarkdown p { color: #e879f9; }          /* ← TEXTO SECUNDÁRIO */
    label { color: #e879f9 !important; }           /* ← LABELS */
    h1, h2, h3 { color: #fdf4ff !important; }     /* ← TÍTULOS */
...
def apply_modern_style(logo_url=""):
    """
    Tema gerado pelo Editor Visual em 14/03/2026 17:14
